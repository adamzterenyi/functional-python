# Functional Python [![](https://github.com/adamzterenyi/functional-python/workflows/tests/badge.svg)](https://github.com/adamzterenyi/functional-python/actions?query=workflow%3Atests)
